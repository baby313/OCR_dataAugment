...
following directory structure.
  ...
  data_dir/image0.jpg
  data_dir/image0.txt # label
  data_dir/image1.jpg
  data_dir/image1.txt # label
  ...
...
tf.app.flags.DEFINE_string('train_directory', '/Users/lairf/AI-projects/ocr/Data/address_train_/',
...
def _convert_to_example(filename, image_buffer, label, text, height, width):
  ...
  example = tf.train.Example(features=tf.train.Features(feature={
      ...
      'image/shape': _bytes_feature(shape.tobytes()),
      'image/colorspace': _bytes_feature(tf.compat.as_bytes(colorspace)),
      'image/channels': _int64_feature(channels),
      'image/class/label': _bytes_feature(label.tobytes()),
  ...
  Args:
    data_dir: string, path to the root directory of images.
      ...
      the following directory structure.
        ...
        data_dir/sample1.jpg
        data_dir/sample1.txt
        ...
        ...
        with open(label_file) as file:
            ...
            if text == SPACE_TOKEN:
                ...
                for i in range(len(text)):
                    if text[i] in encode_maps:
                        label.append(encode_maps[text[i]])
                    else:
